...
function App() {
  ...
  //     <div className="mt-16 lg:mt-0 bg-[url('/assets/img/paymentBg.png')] bg-no-repeat bg-cover bg-center font-radikalLight py-16">
  ...
  //           <p className="paymentPercent">5%</p>
  ...
  //         </div>
  //         <div>
  //           <p className="paymentPercent">20%</p>
  //           <p className="paymentDesc">
  ...
  //           <p className="paymentPercent">10%</p>
  //           <p className="paymentDesc">
  ...
  //         </div>
  //         <div className="border-r border-black">
  //           <p className="paymentPercent">7.5%</p>
  //           <p className="paymentDesc">
  ...
  //         </div>
  //         <div>
  //           <p className="paymentPercent">30%</p>
  //           <p className="paymentDesc">
  ...
  //         <div>
  //           <p className="paymentPercent">30%</p>
  //           <p className="paymentDesc">Project Completion Date</p>
  //         </div>
  //       </div>
  //     </div>
